...
<acme:form>
	...
	<acme:input-textarea code="administrator.banner.form.label.endPeriod" path="endPeriod"/>
	<acme:input-moment code="administrator.banner.form.label.linkPicture" path="linkPicture"/>
	<acme:input-moment code="administrator.banner.form.label.slogan" path="slogan"/>
	<acme:input-money code="administrator.banner.form.label.linkWebDocument" path="linkWebDocument"/>
	<jstl:choose>
